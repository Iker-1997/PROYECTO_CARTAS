...
for y in range(0, mano_enemiga):
    if mano_enemiga[y]["type"] == "infantry" and mano_aliada[y]["type"] == "lancer" or mano_enemiga[y]["type"] == "lancer" and mano_aliada[y]["type"] == "chivalry" or mano_enemiga[y]["type"] == "chivalry" and mano_aliada[y]["type"] == "infantry":
